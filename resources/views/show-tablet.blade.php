                    ...
                    <div x-data="{
                        ...
                        <form id="assign-form-tablet"
                            ...
                            <div x-data="{
                                    ...
                                    options: @js($availableEmployees->map(fn($emp) => [
                                        'id'    => $emp->id,
                                        'label' => $emp->full_name . ($emp->position ? ' (' . $emp->position . ')' : ''),
                                    ])->values()),
                                    get filtered() {
                                ...
                                <div style="position:relative;">
                                    <input type="text" x-model="query" @focus="open = true" @input="open = true"
                                           autocomplete="off" placeholder="Поиск сотрудника..."
                                ...
                                <input type="hidden" name="employee_id" id="employee_id_tablet" :value="selected ?? ''">
